...
% Using the initial values calculated from collocation, the set of odes are
% integrated forward in time to validate the collocation solution
ICs = [x0(1) x0(2) x0(3) x0(4) x0(5) x0(6) L1(1) L2(1) L3(1) L4(1) L5(1) L6(1)];
...
plot3(x_1(end,1),y_1(end,1),z_1(end,1),'.g','MarkerSize',35)
